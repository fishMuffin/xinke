...
public class ExpressPriceReferenceJitu {
    ...
    public ExpressPriceReferenceJitu(Integer id, String destinationProvince, Integer onePointFiveKilogram, Integer oneKilogram, Integer twoKilogram, Integer threeKilogram, Integer perFromThreeToTenContinue, Integer perFromTenFirst, Integer perFromTenContinue, Integer expressCompanyId) {
        this.id = id;
    ...
    public Integer onePointFiveKilogram;
    @ApiModelProperty("1公斤以内价格")
    public Integer oneKilogram;
    @ApiModelProperty("2公斤以内价格")
    public Integer twoKilogram;
    @ApiModelProperty("3公斤以内价格")
    public Integer ThreeKilogram;
    @ApiModelProperty("3-10公斤内每kg价格")
    public Integer perFromThreeToTenContinue;
    @ApiModelProperty("10公斤以上首重")
    public Integer perFromTenFirst;
    @ApiModelProperty("10公斤以上续重")
    public Integer perFromTenContinue;
